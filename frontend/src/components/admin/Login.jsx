      ...
      <div className='w-full max-w-sm p-6 max-md:m-6 border border-primary/30 shadow-xl shadow-primary/15 rounded-lg'>
        <div className='flex flex-col items-center justify-center'>
          <div className='w-full py-6 text-center'>
            ...
            <p className='font-light'>Enter your credintials to access the admin panel</p>
          </div>
          <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
            ...
            <div className='flex flex-col'>
              ...
              <input onChange={(e)=>setPassword(e.target.value)} value={password} type='email' placeholder='your password'  className='border-b-2 border-gray-300 p-2 outline-none mb-6'/>
            </div>
